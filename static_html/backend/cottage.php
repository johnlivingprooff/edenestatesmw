...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Calculate price
    $pricePerNight = ($adults == 1) ? 170 : 170; // Adjusted price for 1 adult guest
    $numNights = (strtotime($checkout) - strtotime($checkin)) / (60 * 60 * 24);
    $price = $numNights * $rooms * $pricePerNight;

    // Prepare email message
    $message = "<h2>BOOKING CONFIRMATION - Family Cottage</h2>";
    ...
    $message .= "<tr><td><b>Number of Rooms:</b></td><td>$rooms Family Cottage(s)</td></tr>";
    ...
    $mail->Subject = 'New Cottage Reservation';
    $mail->Body = $message;
